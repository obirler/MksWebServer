...
function uploadform()
{
    ...
    if(corporationid < 0)
    {
        danger.textContent  = "Lütfen malzemenin gönderildiği yeri seçin!";
    ...
    request.open("POST", "/addoutgoingstockform");
...
function stockformentryListener()
{
    ...
    if(json.responsecode === 0)
    {
        ...
        document.getElementById('shipinfoid').value = "";
        document.getElementById('recorddate').value = "";
        resetselect('corporation');
        resetselect('stockroom');
